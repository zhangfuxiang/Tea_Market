...
public class GroupPurchaseActivity extends BaseActivity implements CommonBaseAdapter.OnItemClickListener<Order>{
    ...
    protected void initView() {
        ...
        group_purchase_rv.setLayoutManager(new LinearLayoutManager(this));
    ...
    public void onItemClick(View view, Order item, int position) {
        ...
        IntentUtils.showIntent(this,GroupPurchaseDetailActivity.class);
