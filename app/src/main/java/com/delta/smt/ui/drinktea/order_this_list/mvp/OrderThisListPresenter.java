...
//@FragmentScope
@ActivityScope
public class OrderThisListPresenter extends BasePresenter<OrderThisListContract.Model, OrderThisListContract.View> {


    @Inject
    public OrderThisListPresenter(OrderThisListContract.Model model, OrderThisListContract.View mView) {
        super(model, mView);
    }
