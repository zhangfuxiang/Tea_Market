...
import com.delta.smt.ui.HomePage.rush_to_purchase.di.DaggerRushBuyDetailComponent;
import com.delta.smt.ui.HomePage.rush_to_purchase.di.RushBuyDetailModule;
...
public class RushToBuyDetailActivity extends BaseActivity<RushBuyDetailPresenter> implements RushBuyDetailContract.View, OnBannerListener, OnTabSelectListener {
    ...
    protected void initView() {
        ...
        com.delta.smt.ui.find.auctionHouseDetail.ProductParaFragment productParaFragment = new ProductParaFragment();
        ...
        mViewPager.setAdapter(new RushToBuyDetailActivity.MyPagerAdapter(getSupportFragmentManager()));
    ...
    protected void componentInject(AppComponent appComponent) {
        ...
        DaggerRushBuyDetailComponent.builder()
                .appComponent(appComponent)
                .rushBuyDetailModule(new RushBuyDetailModule(this))
                .build().inject(this);
    }
    ...
    void onClick(View view) {
        switch (view.getId()) {
            case R.id.toolbar_left_button_arl:
                RushToBuyDetailActivity.this.finish();
                break;
