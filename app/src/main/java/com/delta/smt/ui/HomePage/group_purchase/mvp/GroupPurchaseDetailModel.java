...
public class GroupPurchaseDetailModel extends BaseModel<ApiService> implements GroupPurchaseDetailContract.Model {

    public GroupPurchaseDetailModel(ApiService apiService) {
        super(apiService);
    }
