package com.delta.smt.ui.HomePage.Saleable_good;
...
public class SaleableGoodActivity extends BaseActivity implements CommonBaseAdapter.OnItemClickListener<Order>{
    ...
    @BindView(R.id.sale_able_goods_rv)
    RecyclerView sale_able_goods_rv;
    ...
    protected void initView() {
        ...
        adapter=new CommonBaseAdapter<Order>(this,list) {
            ...
            protected int getItemViewLayoutId(int position, Order item) {
                return R.layout.item_sale_able_goods;
            }
        };

        adapter.setOnItemClickListener(this);
        sale_able_goods_rv.setLayoutManager(new LinearLayoutManager(this));
        sale_able_goods_rv.setAdapter(adapter);
    }
    ...
    protected int getContentViewId() {
        return R.layout.activity_sale_able_goods;
    }
