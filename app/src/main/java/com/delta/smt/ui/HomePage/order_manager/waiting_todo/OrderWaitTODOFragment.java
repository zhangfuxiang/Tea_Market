package com.delta.smt.ui.HomePage.order_manager.waiting_todo;
...
import com.delta.smt.ui.HomePage.order_detail.OrderDetailActivity;
...
public class OrderWaitTODOFragment extends Fragment implements CommonBaseAdapter.OnItemClickListener<Order>{
    ...
    public void onItemClick(View view, Order item, int position) {
        ...
        Intent i=new Intent();
        i.setClass(getContext(), OrderDetailActivity.class);
        startActivity(i);
