...
public class BuyNowBottomDialog extends BaseBottomDialog implements View.OnClickListener {
    ...
    public void bindView(View v) {
        ...
        btnDialogCommitBuy.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_reduce_buy_amount:
                ...
                break;
            case R.id.btn_dialog_commit_buy:
                listener.onOK(Integer.parseInt(etBuyAmount.getText().toString()));
                this.dismiss();
                break;
        }
    }
    ...
    public void setBtnReduceBuyAmountEnable(boolean status) {
        if (status) {
            ...
            btnReduceBuyAmount.setImageResource(R.drawable.ic_cha_reduce_red);
        } else {
            btnReduceBuyAmount.setEnabled(false);
            btnReduceBuyAmount.setImageResource(R.drawable.ic_cha_reduce_gey);
        }
    }

    public void setBottomDialogOKListener(OnBottomDialogOKListener listener) {
        this.listener = listener;
    }

    public interface OnBottomDialogOKListener {
        void onOK(int amount);
    }
}
